                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Guide Bookings</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1> <span class="table-project-n">Guide</span> Lists</h1>
                               ...
                               <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                            ...
                                            <h4 class="m-0 font-weight-bold text-danger">&nbsp &nbsp List of Guides Booked By Tourist</h4>
                                            </div>
                                            <div class="card-body">
                                   ...
                                   <table border='1' data-toggle="table" class="table table-bordered" id="dataTable" width="100%" cellspacing="4"> 
                                        ...
                                        <tr style="border:2px solid black;">
                                         ...
                                         <?php
                                            ...
                                            $b=1;
                                            $c=2;
                                            $query="select * from tbl_guide_booking";                                   
