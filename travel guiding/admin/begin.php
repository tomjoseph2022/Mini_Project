            ...
            <div class="login-form-area mg-t-30 mg-b-40">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <form id="adminpro-form" class="adminpro-form" action="db_functions.php" method="POST">
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-input-area">
                                                <input type="text"  name="admin_name" placeholder="Type your Admin name" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-input-area">
                                                <input type="password" name="admin_password" placeholder="Type your password" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                           ...
                                           <!--     <button type="submit" class="login-button login-button-rg">Register</button>-->
                                                <button type="submit"  name="admin_login"  class="login-button login-button-lg">Log in</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
