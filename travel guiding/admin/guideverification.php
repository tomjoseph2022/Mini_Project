                                                    ...
                                                    <form action="#">
                                                        <div class="form-group-inner">
                                                                  ...
                                                                  <!--  <div class="form-group row">
                                                                    ...
                                                                    <a href="databasefun.php?glogin_id=<?php echo $data['login_id'];?>"class="btn btn-primary btn-user btn-block">Accept</a>
                                                                    <a href="databasefun.php?glogin_rdid=<?php echo $data['login_id'];?> "class="btn btn-primary btn-user btn-block">Reject</a>
                                                                    </form>
