		...
		<div class="wrapper">
			...
			<div class="header-menu">
				...
				<div class="title" style="margin-left: -210px;">Smart Tourist Guiding System</div>
					...
					<ul>
						<li><a href="#"><i class="fas fa-search" style="margin-top: 8px;"></i></a></li>
						<li><a href="#"><i class="fas fa-bell" style="margin-top: 8px;"></i></a></li>
						<li><a href="logout.php"><i class="fas fa-power-off" style="margin-top: 8px;"></i></a></li>
					</ul>
				</div>
			</div>
			<!--header menu end-->
			...
			<?php
 			$uname=$_SESSION['login_id'];
			$sqll="select * from tbl_guide_registration where login_id='$uname'";
