...
$sql= "select tbl_login.*,tbl_guide_registration.*,tbl_guidedetails.*,tbl_regpics.* from tbl_login,tbl_guide_registration,tbl_guidedetails,tbl_regpics where tbl_login.login_id=tbl_guide_registration.login_id and tbl_guide_registration.login_id=tbl_guidedetails.login_id and tbl_guide_registration.login_id=tbl_regpics.login_id";	
    	...
    	<div class="card2" >
			...
			<div class="cardall">
				...
				<div class="carddtls">
					...
					<label >Place :</label><?php echo ($row['firstname']);?><br>
