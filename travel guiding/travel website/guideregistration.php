     ...
     if($num == 0) {
      ...
      mysqli_query($con,$req);
			...
			$usern=$row['login_id'];
      		...
      		$sql = "INSERT INTO tbl_guide_registration(firstname,lastname,address,emails,state,pincode,dobs,username,password,phone,gender,login_id) VALUES ('$fname',' $lname','$add','$eml','$statt','$pincodes','$dob','$phone','$gend',
      					'$usern')"; 
